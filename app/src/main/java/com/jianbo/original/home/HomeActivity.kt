...
//        navigationView.addTab(NavigationMenu.newInstance(this,"0006",android.R.drawable.ic_menu_call).setChecked(true))
        ...
        navigationView_top.addTab(NavigationMenu.newInstance(this,"0001",android.R.drawable.ic_menu_camera).setMode(Menu.MODE_HORIZONTAL))
        ...
        navigationView_top.addTab(NavigationMenu.newInstance(this,"0003",android.R.drawable.ic_menu_call).setMode(Menu.MODE_HORIZONTAL))
        ...
        navigationView_top.addTab(NavigationMenu.newInstance(this,"0005",android.R.drawable.ic_menu_call).setMode(Menu.MODE_HORIZONTAL))
        ...
        navigationView_top.addTab(NavigationMenu.newInstance(this,"0007",android.R.drawable.ic_menu_camera).setMode(Menu.MODE_HORIZONTAL))
    }
}
